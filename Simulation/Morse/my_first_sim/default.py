...
from my_first_sim.builder.robots import Bewegungsprimitiv

# add a new bewegungsPrimitiv robot in the simulation
bewegungsPrimitiv = Bewegungsprimitiv('bewegungsPrimitiv')
#bewegungsPrimitiv.translate(....)
#bewegungsPrimitiv.add_default_interface('socket')
